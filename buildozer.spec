...
# (str) Package name
package.name = animalrecognition

# (str) Package domain (needed for android/ios packaging)
package.domain = com.animal.recognition

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (leave empty to include all the files)
source.include_exts = py,png,jpg,kv,atlas,tflite,aar,jar,so,jar
...
# Do not prefix with './'
source.exclude_patterns = convert_model.py
...
#android.gradle_dependencies = org.tensorflow:tensorflow-lite:2.9.0@aar

# (list) Gradle repositories to add
#android.gradle_repositories =

# (list) JAR files to add (从 AAR 中提取的 classes.jar)
# android.add_jars = %(source.dir)s/tensorflow-lite-2.9.0.jar （Pyjnius方案弃用，改用ctypes直接调用.so）
...
android.add_libs_arm64_v8a = %(source.dir)s/libs/android-v8/*.so
